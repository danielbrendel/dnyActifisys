...
var MAX_ACTIVITY_USERNAME_LENGTH = 35;
var MAX_ACTIVITY_TITLE_LENGTH = 40;
var MAX_ACTIVITY_DESCRIPTION_LENGTH = 130;
window.vue = new Vue({
  el: '#app',
  data: {
    bShowRecover: false,
  ...
  methods: {
    ...
    clearFilterCookies: function clearFilterCookies() {
    ...
    invalidCreateActivity: function invalidCreateActivity() {
      ...
      this.invalidDate(document.getElementById('caDateFrom'), document.getElementById('activity-date-hint'), btn); //this.invalidRequiredInput(document.getElementById('caLocation'), btn);
    },
    ...
    renderActivity: function renderActivity(elem) {
      ...
      var html = '';
      var dtFrom = new Date(elem.date_of_activity_from);
      var dtStrFrom = dtFrom.getFullYear() + "-" + dtFrom.getMonth() + "-" + dtFrom.getDay();
      var dtTill = new Date(elem.date_of_activity_till);
      var dtStrTill = dtTill.getFullYear() + "-" + dtTill.getMonth() + "-" + dtTill.getDay();
      var sameDate = dtStrFrom == dtStrTill;
    ...
    renderMarketItem: function renderMarketItem(item) {
      var banner = window.location.origin + '/gfx/market/' + item.banner;
      var dropdownMenu = '';
    ...
    reportForumPost: function reportForumPost(elemId) {
    ...
    lockGalleryThreadItem: function lockGalleryThreadItem(id) {
