...
window.vue = new Vue({
  ...
  methods: {
    ...
    invalidCreateActivity: function invalidCreateActivity() {
      ...
      this.invalidDate(document.getElementById('caDate'), document.getElementById('activity-date-hint'), btn); //this.invalidRequiredInput(document.getElementById('caLocation'), btn);
    },
