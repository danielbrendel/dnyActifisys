    ...
    <div class="column is-8 is-default-padding">
        <div class="columns is-margin-top-20">
            ...
            <div class="column is-7">
                ...
                <div class="activity-description is-wordbreak">{!! \Purifier::clean(\App\AppModel::translateLinks($activity->description)) !!}</div>
            ...
            <section class="modal-card-body is-stretched">
                <form id="frmEditActivity" method="POST" action="{{ url('/activity/edit') }}">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="text" class="input" name="location" id="eaLocation" value="{{ ucfirst($activity->location) }}" placeholder="{{ __('app.location') }}" onkeyup="document.getElementById('location-list-content-edit').innerHTML = ''; window.vue.queryLocation(this, 'edit', 'eaLocation');" required>
                            <div class="dropdown is-left is-inline-block" id="location-list-edit">
                                <div class="dropdown-menu is-color-black-force" role="menu">
                                    <div class="dropdown-content" id="location-list-content-edit">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="field">
                        <div class="control">
                            <a href="javascript:void(0);" onclick="document.getElementById('additional-options-edit').classList.toggle('is-hidden'); this.remove();">{{ __('app.additional_options') }}</a>
                        </div>
                    </div>

                    <div id="additional-options-edit" class="is-hidden">
                        <div class="field">
