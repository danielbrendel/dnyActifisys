...
return [
    ...
    'login_failed' => 'Failed to login. Please check your credentials. Alternatively you can <a href="javascript:void(0);" onclick="window.vue.bShowRecover = true;">reset your password.</a>',
